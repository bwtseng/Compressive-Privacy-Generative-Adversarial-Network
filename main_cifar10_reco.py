...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='CIFAR-10_Evaluate_Privacy')
    ...
    #parser.add_argument('--weights_path',type=str, help='Weights of the trained Generator')
    #parser.add_argument('--model_path',type=str, help='Weights of the trained Generator')
    ...
    if args.train:
        import cifar10_reco
        model = cifar10_reco.shakenet(args)
        model.train()
